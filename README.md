...
version 1: basic planner with just the fundamentals
version 1.1-1.9: will be constant tweaking and refining code for it to be essentially perfect for use

version 2 input of cosmetics, themes and maybe some sort of quests? in a way to make it more engaging to use which could also benefit me for people with low attention spans as it will kind of gve them a  reason to come back.

version 2.1- 2.9 constant refining with my current ideas and personalization

version 3 possible release, with feedback from the community if it goes public ill be able to make v3.1-v3.9 refined on feedback data while also refining ill implement a sort of subscription plan if it goes well

version 4 possible final refinement with only cosmetic and personalized future updates. maybe implement ads instead of using subscriptions or have the free version use ads and paid have no ads and such with extra benefits. only as a way to support my project
